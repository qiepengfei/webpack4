...
// CONCATENATED MODULE: ./src/static/js/aceshi1/App.jsx
...
function (_React$Component) {
  _inherits(Aceshi1, _React$Component);
  ...
  function Aceshi1() {
    ...
    _classCallCheck(this, Aceshi1);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Aceshi1)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(Aceshi1, [{
    ...
    value: function render() {
      ...
      }), react_default.a.createElement("h1", null, "aceshi1!!")));
    }
  }]);
...
App_Aceshi1.propTypes = {
  oriProps: prop_types_default.a.object.isRequired
};
/* harmony default export */ var App = (App_Aceshi1);
// CONCATENATED MODULE: ./src/static/js/aceshi1/main.js
